...
const Banner = () => {
    ...
    return (
      ...
      <h1 className="text-3xl font-bold mb-2 text-black">Welcome to Bengali Recipe!</h1>
      <p className="text-lg mb-4 text-black font-bold pt-4 pb-12">Try all kind of Bengali foods and enjoy.</p>
